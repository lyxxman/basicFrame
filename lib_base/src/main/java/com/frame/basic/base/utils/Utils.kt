...
fun getVersionCode(): Long {
    val packageInfo = BaseApplication.application
        .packageManager
        .getPackageInfo(BaseApplication.application.packageName, 0)
 ...
 * 获取对象的唯一码
 */
fun getUnicode(any: Any) = "${any.javaClass.name}@${Integer.toHexString(System.identityHashCode(any))}"